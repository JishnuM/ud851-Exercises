...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_JSON_RESULT_KEY = "search_json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            if (savedInstanceState.containsKey(SEARCH_JSON_RESULT_KEY)) {
                mSearchResultsTextView.setText(savedInstanceState.getString(SEARCH_JSON_RESULT_KEY));
            }
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String currentQueryUrl = mUrlDisplayTextView.getText().toString();
        outState.putString(QUERY_URL_KEY, currentQueryUrl);
        ...
        String currentSearchResultJson = mSearchResultsTextView.getText().toString();
        outState.putString(SEARCH_JSON_RESULT_KEY, currentSearchResultJson);
    }
}