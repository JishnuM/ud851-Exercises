...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        long hrsUntilBoarding = TimeUnit.MINUTES.toHours(minsUntilBoarding);
        long minsLessHoursUntilBoarding = minsUntilBoarding - TimeUnit.HOURS.toMinutes(hrsUntilBoarding);
        String hrsAndMinsUntilBoarding = String.format("%d:%d", hrsUntilBoarding, minsLessHoursUntilBoarding);
        mBinding.textViewBoardingInCountdown.setText(hrsAndMinsUntilBoarding);
    }
}
